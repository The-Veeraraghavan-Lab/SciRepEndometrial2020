...
```{r, echo=FALSE, warning=FALSE}
 ...
 # Basic data exploration
  ...
  print(sum(as.numeric(feat.data$CT_Make==1),na.rm=T)) #GE
  print(sum(as.numeric(feat.data$CT_Make==2),na.rm=T)) #Philips
  print(sum(as.numeric(feat.data$CT_Make==3),na.rm=T)) #Seimens
  print(sum(as.numeric(feat.data$CT_Make==4),na.rm=T)) #Toshiba
  
  print(sum(as.numeric(feat.data$FIGO==1),na.rm=T)) #Poorly differentiated
  print(sum(as.numeric(feat.data$FIGO==2),na.rm = T)) #Well differentiated
  
  print(sum(as.numeric(feat.data$Stage==1),na.rm=T)) #Extra-uterine
  print(sum(as.numeric(feat.data$Stage==2),na.rm = T)) #Uterus-confined
  
  print(sum(as.numeric(feat.data$Histology==1),na.rm=T)) #Carcinosarcoma
  print(sum(as.numeric(feat.data$Histology==2),na.rm = T)) #Clear-cell
  print(sum(as.numeric(feat.data$Histology==3),na.rm=T)) #Endometrioid
  print(sum(as.numeric(feat.data$Histology==4),na.rm = T)) #High-grade
  print(sum(as.numeric(feat.data$Histology==5),na.rm=T)) #Serous
  print(sum(as.numeric(feat.data$Histology==6),na.rm = T)) #Undifferentiated/de-differentiated
...
```{r, echo=FALSE}
  ...
  ## difference in grade between training and testing set
  wilcox.test(train_set_All$FIGO, test_set_All$FIGO)
  
  ## difference in stage between training and testing set
  wilcox.test(train_set_All$Stage, test_set_All$Stage)
